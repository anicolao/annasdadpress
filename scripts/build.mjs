...
await sharp(
  Buffer.from(
    `<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg"><rect width="1200" height="630" fill="#f7f6f0"/><rect x="65" y="65" width="90" height="90" fill="#066568"/><text x="84" y="125" font-family="Georgia" font-size="55" fill="white">a</text><text x="185" y="128" font-family="Georgia" font-size="46" fill="#142e3c">Anna’s Dad Press</text><text x="65" y="300" font-family="Georgia" font-size="76" fill="#142e3c">A little curiosity.</text><text x="65" y="395" font-family="Georgia" font-size="76" fill="#142e3c">A new perspective.</text><text x="65" y="490" font-family="Georgia" font-size="76" font-style="italic" fill="#066568">Your next step.</text><text x="65" y="580" font-family="sans-serif" font-size="20" fill="#142e3c">INDEPENDENT PUBLISHING · CANADA</text></svg>`,
  ),
)
  .png()
